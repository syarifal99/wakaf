        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    @endif
                    <div class="card-body">
                        <form action="{{url('/Mitra/update/'.$gambar->id_mitra)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="Nama_Mitra" class=" form-control-label">Nama
                                            ...
                                            placeholder="Masukkan Nama Mitra" class="form-control" value="{{ $gambar->nm_mitra }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="Nama_pj" class=" form-control-label">Penanggung Jawab</label><input
                                            ...
                                            class="form-control" value="{{ $gambar->nm_pjmitra }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="No_Rek" class=" form-control-label">Nomor Rekening</label><input
                                            ...
                                            class="form-control" value="{{ $gambar->no_rek }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="username" class=" form-control-label">Username</label><input
                                            ...
                                            class="form-control" value="{{ $gambar->username }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="email" class=" form-control-label">Email</label><input
                                            ...
                                            class="form-control"value="{{ $gambar->email }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="password" class=" form-control-label">Password</label><input
                                            ...
                                            class="form-control" value="{{ $gambar->password }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="telpon" class=" form-control-label">No Telpon</label><input
                                            ...
                                            class="form-control" value="{{ $gambar->no_hp }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="avatar" name="logo_mitra"
                                            class="form-control-file" value="{{ $gambar->logo_mitra }}">
                                    </div>
                                </div>
                            </div>
